            ...
            <div class="min-h-screen bg-cover bg-center flex items-center justify-center {{ vm.filter.minimal ? '' : bgImageClass }}">
                <div>
                    ...
                    <div class="relative">
                        <div [ngStyle]="{ width: vm.filter.minimal ? '50vw' : '60vw'}" style="height: 50vh"
                            ...
                            <div style="height: 80%" class="w-full h-full overflow-auto">
                                <div class="w-full h-full flex flex-col justify-center items-center">
                                    <div
                                            [ngClass]="{ 'pl-64': vm.filter.minimal && vm.filter.hideRight, 'pr-64': vm.filter.minimal && vm.filter.hideLeft, 'px-64': !vm.filter.minimal }"
                        ...
                        <!-- right hand -->
                        <div *ngIf="!vm.filter.hideLeft" style="transform: scale(165%) translateX(-28%)"
